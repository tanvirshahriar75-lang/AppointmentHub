...
public class DashboardVCActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onRefresh() {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(DashboardVCActivity.this, getString(R.string.refreshed), Toast.LENGTH_SHORT).show();
                    }
                }, 1000);
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(DashboardVCActivity.this, getString(R.string.add_appointment), Toast.LENGTH_SHORT).show();
            }
        });
    }
